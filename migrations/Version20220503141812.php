 ...
 */
final class Version20220503141812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE photo photo_name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE photo_name photo VARCHAR(255) NOT NULL');
